...
module.exports = {
  ...
  // theme: require.resolve('../../vdoing'), // 使用本地主题 (先将vdoing主题文件下载到本地：https://github.com/xugaoyi/prompter)
  ...
  themeConfig: {
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'Glimis', // 必需
      href: 'https://github.com/glimis' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:912239196@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/glimis'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'Glimis | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
